...
export default function CTAButton({label='Order Now', link='/', 
  ...
  return (
    <Link to='/' className={` py-3 pl-6 pr-4 2xl:py-4 2xl:pl-8 2xl:pr-4 rounded-full text-(--white) 
    ...
    group cursor-pointer ${className}`}>
        ...
        <div className='relative flex items-center justify-center'>
            ...
            group-hover:w-100 2xl:group-hover:w-[600px] 
            group-hover:h-20 2xl:group-hover:h-30
